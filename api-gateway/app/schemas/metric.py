...
class MetricDefCreateRequest(MetricDefBase):
    ...
    @classmethod
    def validate_range(cls, v: Optional[Decimal], info) -> Optional[Decimal]:
...
class ExtractedMetricBulkCreateRequest(BaseModel):
    ...
    metrics: list[ExtractedMetricCreateRequest] = Field(..., description="List of metrics to create/update")
