...
export const useParticipantsStore = defineStore('participants', () => {
  ...
  async function searchParticipants(params = {}) {
    ...
    try {
      ...
      const normalized = normalizeApiError(err, 'Ошибка загрузки участников')
  ...
  async function getParticipant(participantId) {
    ...
    try {
      ...
      const normalized = normalizeApiError(err, 'Ошибка загрузки участника')
      error.value = normalized.message
      err.normalizedError = normalized
      throw err
    } finally {
  ...
  async function createParticipant(participantData) {
    ...
    try {
      ...
      const normalized = normalizeApiError(err, 'Ошибка создания участника')
      error.value = normalized.message
      err.normalizedError = normalized
      throw err
    } finally {
  ...
  async function updateParticipant(participantId, participantData) {
    ...
    try {
      ...
      const normalized = normalizeApiError(err, 'Ошибка обновления участника')
      error.value = normalized.message
      err.normalizedError = normalized
      throw err
    } finally {
  ...
  async function deleteParticipant(participantId) {
    ...
    try {
      ...
      const normalized = normalizeApiError(err, 'Ошибка удаления участника')
      error.value = normalized.message
      err.normalizedError = normalized
      throw err
    } finally {
