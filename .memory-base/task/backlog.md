Backlog (актуальная версия, фокус на финальном отчёте, Vision и VPN)
...
Приоритет 1 — Gemini Vision → Нормализация (строго по .memory-base)
...
- VISION-01: Gemini Vision (основной поток)
